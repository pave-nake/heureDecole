...
imagestart =tk.PhotoImage(file="D:/documents/NSI/group game/nongroup/games/heuredecole/resources/CLASSROOMclosed.png") 
classclosednormal=tk.PhotoImage(file="D:/documents/NSI/group game/nongroup/games/heuredecole/resources/CLASSROOMnormalclosed.png")
classopennormal=tk.PhotoImage(file="D:/documents/NSI/group game/nongroup/games/heuredecole/resources/CLASSROOMnormalopen.png") 
classclosedchaos=tk.PhotoImage(file="D:/documents/NSI/group game/nongroup/games/heuredecole/resources/CLASSROOMchaosclosed.png") 
classopenchaos=tk.PhotoImage(file="D:/documents/NSI/group game/nongroup/games/heuredecole/resources/CLASSROOMchaosopen.png") 
student1=tk.PhotoImage(file="D:/documents/NSI/group game/nongroup/games/heuredecole/resources/stick.png") 
student2=tk.PhotoImage(file="D:/documents/NSI/group game/nongroup/games/heuredecole/resources/vadim.png")
student3=tk.PhotoImage(file="D:/documents/NSI/group game/nongroup/games/heuredecole/resources/chamber.png") 
teacherangry=tk.PhotoImage(file="D:/documents/NSI/group game/nongroup/games/heuredecole/resources/teacherangry.png")
teachercalm=tk.PhotoImage(file="D:/documents/NSI/group game/nongroup/games/heuredecole/resources/teachercalm.png")
gameover_image=tk.PhotoImage(file="D:/documents/NSI/group game/nongroup/games/heuredecole/resources/game_over.png")
logo=tk.PhotoImage(file="D:/documents/NSI/group game/nongroup/games/heuredecole/resources/logo.png")
...
highscoretop3=canvas.create_text(120, 160, text='', font=("Arial", 18), fill="white",)
...
def write_highscore(score, name):
    with open("D:/documents/NSI/group game/nongroup/games/heuredecole/resources/highscores.txt", "a") as file:
        file.write(f"{score} {name[0:8]} {now}\n")

def sort_highscores():
    scores = []
    with open("D:/documents/NSI/group game/nongroup/games/heuredecole/resources/highscores.txt", "r") as file:
        for line in file:
            score, name,time1,time2 = line.strip().split(' ')
            scores.append((int(score), name,time1,time2))
    scores.sort(reverse=True)
    with open("D:/documents/NSI/group game/nongroup/games/heuredecole/resources/highscores.txt", "w") as file:
...
def highscorescreen():
    ...
    hs=f''
    for elem in top3:
        scoretop,nametop,time1,time2=elem.split(' ')
...
def started():
    ...
    removehighscorescreen()
    update_score()
    fen.after(ri(3000,20000-(dooreventscompleted*750)), door_events)
    canvas.focus_set()
    name_entry.unbind("<Key>")
...
def update_score():
    global score,multiplier,recursive,scoredelay,is_started
    display_score()
    if recursive:fen.after(scoredelay, update_score)
    if is_started:score+=1
...
def door_events():
    ...
    dooreventscompleted+=1
    if recursive:fen.after(ri(7500,20000-(dooreventscompleted*750)), door_events)
    listeposib=['teacher','teacher','teacher','student']
    event=listeposib[ri(0,len(listeposib)-1)]
    if recursive:opendoor()
    fen.after(4000-(dooreventscompleted*250), continue_doorevents1)
